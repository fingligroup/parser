...
class CORE_DontrRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
        ...
        $this->config = [
            ...
            'list'    => [
                ...
                'container'           => '.rubric-list',
                    ...
                    'element'             => '.rubric-list__item',
                        ...
                        'element-link'        => '.rubric-list__image[href]',

                        // css селектор для названия элемента
                        // (опционально)
                        'element-title'       => '.rubric-list__title a',

                        // css селектор для описания элемента
                        // (опционально)
                        'element-description' => '.rubric-list__description',
                        ...
                        // css селектор для даты элемента
                        // (опционально)
                        'element-date'        => '.rubric-list__data',
            ],
            ...
            'element' => [
                ...
                'container'           => '.content-aside-right',
                    ...
                    // (можно несколько через запятую, если есть разные шаблоны новости)
                    // (обязательный)
                    'element-text'        => '.news-card__bottom .news-card__bottom-cell:last-child',
                ...
                // (опционально)
                'ignore-selectors'    => '.news-card__tags, .comments',
