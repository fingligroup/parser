...
// part 4
class CORE_GorobzorRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'site'    => [
                ...
                // H - час
                // i - минуты
                'date_format' => 'Y-m-d\TH:i:sP', //2020-10-26T19:22:41+05:00  d.m.Y H:i
            ...
            'element' => [
                ...
                // (обязательный)
                'container'           => 'article.c-page-content__inner',
                ...
                // (можно несколько через запятую, если есть разные шаблоны новости)
                // (обязательный)
                'element-text'        => '.c-page-content__content',

                // css-селектор даты создания новости
                // (опционально)
                'element-date'        => 'time.c-page-content__n-time[datetime]',
                ...
                // (опционально)
                'element-image'       => 'figure img[data-src]',
                ...
                // (опционально)
                'ignore-selectors'    => '.c-page-content__content h1',
