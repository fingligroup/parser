...
// part 4
class CORE_StapravdaRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'list'    => [
                ...
                // (обязательный)
                'url'                 => 'https://stapravda.ru/news/',

                // css селектор для контейнера витрины
                // (обязательный)
                'container'           => '.news-page div.col-12.col-lg-8',
                ...
                'element-link'        => '.card-title a[href]',

                // css селектор для названия элемента
                // (опционально)
                'element-title'       => '.card-title a',
                ...
                // (опционально)
                //                'element-image'       => '.card-body img[src]',

                // css селектор для даты элемента
                // (опционально)
                'element-date'        => '.text-muted',
            ],
            ...
            'element' => [
                ...
                // (опционально)
                'element-image'       => '.article-text .article-figure img[data-flickity-lazyload]',
                ...
                // (опционально)
                'ignore-selectors'    => '.article-carousel',
