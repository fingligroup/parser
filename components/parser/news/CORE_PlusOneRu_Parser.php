...
// part 4
class CORE_PlusOneRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'list'       => [
                ...
                // (обязательный)
                'container'           => '.BlocksViewer__BlocksViewerContainer-b7ack-0',

                // css селектор для элемента витрины (относительно контейнера)
                // (обязательный)
                'element'             => '.Grid__GridItemGroup-sc-12ar20u-7',
                ...
                'element-link'        => '.Grid__AWrap-sc-12ar20u-8[href]',

                // css селектор для названия элемента
                // (опционально)
                'element-title'       => '.style__NewsTitle-sc-15gmr2r-3',
            ...
            'element'    => [
                ...
                // (опционально)
                'element-date'        => '.style__TagHeaderDate-sc-1k5l37f-4',
                ...
                // (опционально)
                'element-image'       => '.FullWidthPic__FullWidthPicImg-sc-4oiju1-2[src]',
