...
class CORE_NewsstokRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (обязательный)
                'container'           => 'article.single-post-content',
                    ...
                    // (опционально)
                    'element-image'       => 'div.entry-content.clearfix.single-post-content > p:nth-child(1) > img[data-src]',
