...
class CORE_MoscowPostSu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'list'    => [
                ...
                'element-link'        => '.articles-item a[href]',

                // css селектор для названия элемента
                // (опционально)
                'element-title'       => '.title_article a, #author .h3',
                ...
                // (опционально)
                'element-image'       => '.img_article img[src]',
            ...
            'element' => [
                ...
                // css селектор для описания элемента
                // (опционально)
                'element-description' => '.article_description',

                // css селектор для получения картинки
                // !должен содержать конечный аттрибут src! (например: img.main-image[src])
                // (опционально)
                'element-image'       => '[itemprop="image"] img[src]',
