...
class CORE_OdintsovoInfo_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
        ...
        $this->config = [
            ...
            'element' => [
                ...
                'container'           => '.contentCenter',
                    ...
                    // (можно несколько через запятую, если есть разные шаблоны новости)
                    // (обязательный)
                    'element-text'        => '.article.article--news',
                    ...
                    // (опционально)
                    'element-image'       => '.fancybox.zoom-in.show3 href[src]',
                ...
                // (опционально)
                'ignore-selectors'    => '.breadcrumb, .container-fluid.mt-3, .news-item-panel, .news-item-rating-panel, .news-item-like-container, .news-item-rating-panel, .comment-main, .mO-yM',
