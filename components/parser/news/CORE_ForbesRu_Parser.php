...
// part 4
class CORE_ForbesRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (можно через запятую)
                // (опционально)
                'ignore-selectors'    => '.subscribe.subscribe-article, .forbes-readmore, .tags-list, a[href="https://www.forbes.ru/guideforbusiness"], .partners, h2 a',
            ]
        ];
