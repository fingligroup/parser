...
// part 4
class CORE_GazetaVpRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (опционально)
                'element-image'       => '.td-post-featured-image a[href]',
                ...
                // (опционально)
                'ignore-selectors'    => '.td-post-content p:first-of-type, .td-post-featured-image, .td-adspot-title',
