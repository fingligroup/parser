...
// part 4
class CORE_NashemediaRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (опционально)
                'element-image'       => '.featured-image img[src]',
                ...
                // (опционально)
                'ignore-selectors'    => '.mistape_caption, .heateor_sss_sharing_container',
