...
class CORE_KrasnoyarskmediaRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'rss'     => [
                ...
                // (обязательный)
                'url'                 => '/export/new/news_main26.rss',
            ...
            'element' => [
                ...
                // (можно через запятую)
                // (опционально)
                'ignore-selectors'    => '#soc_invites_block',
            ]
        ];
