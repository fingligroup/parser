...
// part 4
class CORE_InforeactorRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (опционально)
                'element-date'        => '.news_time',

                // css селектор для описания элемента
                // (опционально)
                'element-description' => '.js-mediator-article p[itemprop="description"]',

                // css селектор для получения картинки
                // !должен содержать конечный аттрибут src! (например: img.main-image[src])
                // (опционально)
                //                'element-image'       => '.baseImg image[src]',
                'element-image'       => 'div[itemprop="image"] img[src]',
                ...
                // (опционально)
                'ignore-selectors'    => '.js-mediator-article p[itemprop="description"], .tags',
