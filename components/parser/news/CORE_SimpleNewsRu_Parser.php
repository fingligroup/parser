...
// part 4
class CORE_SimpleNewsRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'list'    => [
                ...
                // (обязательный)
                'container'           => '#s926265672',

                // css селектор для элемента витрины (относительно контейнера)
                // (обязательный)
                'element'             => '.s2013095130:nth-child(2) .s2713726059',
            ...
            'element' => [
                ...
                //                'element-description' => 'meta[name="description"][content]',

                // css селектор для получения картинки
                // !должен содержать конечный аттрибут src! (например: img.main-image[src])
                // (опционально)
                'element-image'       => 'img.post-item__big-photo-img[src]',
