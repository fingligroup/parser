    ...
    public function __construct()
    {
        $this->config = [
            ...
            'list'    => [
                ...
                // (опционально)
                'element-date'        => 'ul.list-inline li',
            ],
            ...
            'element' => [
                ...
                // css селектор для описания элемента
                // (опционально)
                'element-description' => '.detailtext > p:first-of-type',

                // css селектор для получения картинки
                // !должен содержать конечный аттрибут src! (например: img.main-image[src])
                // (опционально)
                'element-image'       => 'img.news-picture[data-src]',
                ...
                // (опционально)
                'ignore-selectors'    => '.detailtext > p:first-of-type, div[style="margin:1rem 0;"]',
