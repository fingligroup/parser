    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (можно несколько через запятую, если есть разные шаблоны новости)
                // (обязательный)
                'element-text'        => '#articleContainer .b-material-wrapper__text',

                // css-селектор даты создания новости
                // (опционально)
                'element-date'        => '.b-material-head__date',
                ...
                // (опционально)
                'ignore-selectors'    => 'a.b-read-more__picture',
