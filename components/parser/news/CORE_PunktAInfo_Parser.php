...
class CORE_PunktAInfo_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
        ...
        $this->config = [
            ...
            'list'    => [
                ...
                'container'           => '.column-two-third',
                    ...
                    'element'             => '.news-item',
                        ...
                        // css селектор для названия элемента
                        // (опционально)
                        'element-title'       => '.title-news-a',

                        // css селектор для описания элемента
                        // (опционально)
                        'element-description' => '.news-preview-text',

                        // css селектор !должен содержать конечный аттрибут src! для картинки элемента
                        // (опционально)
                        'element-image'       => 'img.preview_picture[src]',
            ...
            'element' => [
                ...
                'container'           => '.column-two-third',
                    ...
                    // (можно несколько через запятую, если есть разные шаблоны новости)
                    // (обязательный)
                    'element-text'        => '.text[itemprop=description]',
