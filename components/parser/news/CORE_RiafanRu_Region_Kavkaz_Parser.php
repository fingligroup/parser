...
class CORE_RiafanRu_Region_Kavkaz_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'site'    => [
                // протокол и домен
                // (обязательный)
                'url'         => 'https://riafan.ru/region/kavkaz',
            ...
            'list'    => [
                ...
                // (обязательный)
                'container'           => 'category-news-block[first_page_data="categoryMain"]',
            ...
            'element' => [
                ...
                // (обязательный)
                'container'           => '.single_block_content_txt',
                ...
                // (опционально)
                'element-image'       => 'p:first-child img[src]',
                ...
                // (опционально)
                'ignore-selectors'    => '.image-wrapper',
                ...
                // (опционально)
                'element-text-after'  => '.single_author',
            ]
        ];
