...
class CORE_MisternewsRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (опционально)
                'element-image'       => 'img.size-full[src]',
                ...
                // (опционально)
                'ignore-selectors'    => 'a[href^="https://zachete.ru/?ref_id=10001254"], .yarpp-related, .post-share, .post-navigation',
