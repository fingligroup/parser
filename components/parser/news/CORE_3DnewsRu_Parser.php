...
// part 4
class CORE_3DnewsRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // css селектор для описания элемента
                // (опционально)
                'element-description' => '.js-mediator-article > p:first-child',
                ...
                // (опционально)
                'ignore-selectors'    => '.js-mediator-article > p:first-child, .source-wrapper .caption-wrapper',
