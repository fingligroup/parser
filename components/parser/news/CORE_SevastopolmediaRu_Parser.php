...
class CORE_SevastopolmediaRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'rss'     => [
                ...
                // (обязательный)
                'url'                 => '/export/new/news_main120.rss',
            ...
            'element' => [
                ...
                // (опционально)
                'element-quote'       => 'p.fn-quote',

                // игнорируемые css-селекторы
                // (можно через запятую)
                // (опционально)
                'ignore-selectors'    => '#soc_invites_block, .news_links_related',
            ]
        ];
