...
// part 4
class CORE_WwwCinemotionlabCom_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'site'    => [
                // протокол и домен
                // (обязательный)
                'url'         => 'http://www.cinemotionlab.com',
            ...
            'element' => [
                ...
                // (опционально)
                'element-image'       => '.float_pic img[src]',
                ...
                // (опционально)
                'ignore-selectors'    => '.state .float_pic ~ p:first-child',
