...
class CORE_ProducttodayRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
...
//                'element-description' => 'description',
            ...
            'element' => [
                ...
                // (заполняется только, если отсутствует в витрине)
                'element-image'       => '.attachment-full[src]',
                ...
                // (можно через запятую)
                // (опционально)
                'ignore-selectors'    => '.wp-embedded-content',
            ]
        ];
