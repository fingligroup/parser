...
// part 4
class CORE_MediazavodRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // css селектор для описания элемента
                // (опционально)
                'element-description' => '.news-item__text p:first-of-type',
                ...
                // (опционально)
                'ignore-selectors'    => '.news-item__text p:first-of-type',
