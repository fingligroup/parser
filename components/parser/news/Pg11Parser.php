...
class Pg11Parser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://pg11.ru';
    public const NEWSLIST_URL = 'https://pg11.ru/rss';
