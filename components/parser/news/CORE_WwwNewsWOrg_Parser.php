...
// part 4
class CORE_WwwNewsWOrg_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // css селектор для описания элемента
                // (опционально)
                //                'element-description' => '.full-text p:first-of-type',

                // css селектор для получения картинки
                // !должен содержать конечный аттрибут src! (например: img.main-image[src])
                // (опционально)
                'element-image'       => 'a.highslide[href]',

                // css-селектор для цитатыhighslide img[src]
                ...
                // (опционально)
                //                'ignore-selectors'    => '.full-text p:first-of-type',
