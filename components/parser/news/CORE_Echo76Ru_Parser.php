...
// part 4
class CORE_Echo76Ru_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (можно через запятую)
                // (опционально)
                'ignore-selectors'    => '#yandex_rtb_R-A-155167-5, h1, img.newsphoto, p.text-right, .ya-share2, #yandex_rtb_R-A-155167-1, .smallred, .row, a[href="https://t.me/echo76"]',
            ]
        ];
