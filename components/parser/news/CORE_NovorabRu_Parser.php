    ...
    public function __construct()
    {
        $this->config = [
            ...
            'list'    => [
                ...
                // (опционально)
                'element-date'        => 'span.post-meta-item-value',
            ],
            ...
            'element' => [
                ...
                // (опционально)
                'element-image'       => 'figure.featured-caption img[src]',
                ...
                // (опционально)
                'ignore-selectors'    => '.post-footer, .meta-date, h1, div[style="display:flex; align-items:center; margin: 10px 0"], .post-author, figure.featured-caption img[src]',
