...
// part 4
class CORE_KavcommentRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (опционально)
                'element-image'       => '.entry-thumbnail img[src]',
                ...
                // (опционально)
                'ignore-selectors'    => '.entry-content > p:first-of-type, .post-views, .tptn_counter, .entry-tags, .social_b',
