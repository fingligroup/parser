...
// part 4
class CORE_ZavtraRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // css селектор для описания элемента
                // (опционально)
                'element-description' => '.article__content p:first-of-type',
                ...
                // (опционально)
                'ignore-selectors'    => '.article__content p:first-of-type, .zen_inv, .banner-first-par, span[type-bloc="onep"]',
