...
class CORE_Vesti22Tv_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (можно через запятую)
                // (опционально)
                'ignore-selectors'    => '.post-page__header, .post-page__info, .post-page__footer, .d-none.d-lg-block.col-lg-12.pt-3, .post-page__preview-footer',
            ]
        ];
