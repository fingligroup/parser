...
// part 4
class CORE_BatayskGorodRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (обязательный)
                'element-text'        => '.js-mediator-article',
                ...
                // css селектор для описания элемента (относительно элемента)
                // (заполняется только, если отсутствует в витрине)
                'element-description' => '.js-mediator-article p:first-of-type',
                ...
                // (опционально)
                //                'element-quote'       => '.js-mediator-article i',
                'element-quote'       => '.js-mediator-article p:not(:first-child) i',

                // игнорируемые css-селекторы
                // (можно через запятую)
                // (опционально)
                'ignore-selectors'    => '.js-mediator-article > p:first-of-type',
            ]
        ];
