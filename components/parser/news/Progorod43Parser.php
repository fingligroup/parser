...
class Progorod43Parser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://progorod43.ru/';
    public const NEWSLIST_URL = 'https://progorod43.ru/rss';
