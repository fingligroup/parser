...
// part 4
class CORE_HightechFm_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
...
//                'element-description' => 'description',
            ...
            'element' => [
                ...
                // (можно несколько через запятую, если есть разные шаблоны новости)
                // (обязательный)
                'element-text'        => '.page-content__body',

                // css-селектор даты создания новости
                // (опционально)
                'element-date'        => '.category__date',

                // css селектор для описания элемента
                // (опционально)
                'element-description' => '.page-content__lead',
