...
class CORE_GetafishaRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (обязательный)
                'container'           => 'div[itemtype="http://schema.org/Article"]',
                ...
                // (опционально)
                'element-image'       => 'img.card-img-top[src]',
                ...
                // (опционально)
                'ignore-selectors'    => '.uSocial-Share',
