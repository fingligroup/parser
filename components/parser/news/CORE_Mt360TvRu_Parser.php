...
// part 4
class CORE_Mt360TvRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (обязательный)
                'container'           => '#double-column-container',
