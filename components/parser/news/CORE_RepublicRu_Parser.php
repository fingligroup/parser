...
// part 4
class CORE_RepublicRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'list'    => [
                ...
                'element-link'        => '.card__link[href]',

                // css селектор для названия элемента
                // (опционально)
                'element-title'       => '.card__title',
            ...
            'element' => [
                ...
                // (опционально)
                'element-date'        => '.post-meta__published-at',

                // css селектор для описания элемента
                // (опционально)
                'element-description' => '.post-header__excerpt',

                // css селектор для получения картинки
                // !должен содержать конечный аттрибут src! (например: img.main-image[src])
                // (опционально)
                'element-image'       => '.post-heroimage__image[src]',
