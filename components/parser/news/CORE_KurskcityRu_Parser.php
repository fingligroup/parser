...
// part 4
class CORE_KurskcityRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'list'    => [
                ...
                // (обязательный)
                'url'                 => 'http://kurskcity.ru/news/main/',

                // css селектор для контейнера витрины
                // (обязательный)
                'container'           => '#list_news_bl',
                ...
                'element-link'        => '.post-inner a[href]',

                // css селектор для названия элемента
                // (опционально)
                'element-title'       => '.post-inner a img[alt]',
                ...
                // (опционально)
                //                'element-image'       => '.post-inner a img[src]',

                // css селектор для даты элемента
                // (опционально)
                'element-date'        => '.mainnewsdate',
            ],
            ...
            'element' => [
                ...
                // (опционально)
                'element-image'       => '.newsbigimg img[src]',
