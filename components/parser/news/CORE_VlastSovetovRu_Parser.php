...
class CORE_VlastSovetovRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'list'    => [
                ...
                // (обязательный)
                'url'                 => 'https://vlast-sovetov.ru/category/news/',

                // css селектор для контейнера витрины
                // (обязательный)
                'container'           => '.archive__loop',

                // css селектор для элемента витрины (относительно контейнера)
                // (обязательный)
                'element'             => '.col-hd-4.col-th-6.col-tv-6',
                ...
                'element-link'        => '.content a[href]',

                // css селектор для названия элемента
                // (опционально)
                'element-title'       => '.clasic__post h3',
            ...
            'element' => [
                ...
                // (можно несколько через запятую, если есть разные шаблоны новости)
                // (обязательный)
                'element-text'        => '.s__content-container',
                ...
                // (опционально)
                'element-image'       => '.wp-post-image img[src]',
