...
// part 4
class CORE_InvestingsInfo_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (опционально)
                'element-image'       => '.td-post-content.tagdiv-type img[src]',
                ...
                // (опционально) div.td-post-content.tagdiv-type > p:nth-child(1) img,
                'ignore-selectors'    => 'div.td-post-content.tagdiv-type > p:nth-child(1) a',
